...
public class Hand extends TreeSet<Card> implements IHand {
	...
	public Map<Integer, List<Card>> group() {
		...
		// for (card...)
		// map.put , new arraylist dans laquelle je vais mettre la carte
		// map.get de 4 par ex, sinon put dans new arraylist
		// puis map.get de 4, déjà une liste donc add? avec if
